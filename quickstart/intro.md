...
The later chapters follow [Going Further](https://projectcapsule.dev/docs/quickstart/extended/): Pod Security Standards, Service restrictions, permissions, resource distribution, and resource pools. Continue with workload priority, registry credentials, group ownership, a second Tenant, and advanced Proxy permissions. Finish by comparing Alice and Bob through OIDC login and Headlamp.
