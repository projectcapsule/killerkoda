...
The later chapters build on [Going Further](https://projectcapsule.dev/docs/quickstart/extended/): Pod Security Standards, Service restrictions, permissions, and workload priority, followed by resource distribution, registry credentials, and resource pools. Then explore group ownership, a second Tenant, and advanced Proxy permissions. Finish by comparing Alice and Bob through OIDC login and Headlamp.
